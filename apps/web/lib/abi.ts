...
export const projectHomeRegistryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ProjectHomeRegistry.Project",
        "components": [
          {
            "name": "id",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "status",
        "type": "tuple",
        "internalType": "struct OracleGuard.PriceStatus",
        "components": [
          {
            "name": "state",
            "type": "uint8",
            "internalType": "enum OracleGuard.OracleState"
          },
          {
            "name": "answer",
            "type": "int256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct OracleGuard.AssetConfig",
        "components": [
          {
            "name": "feed",
            "type": "address",
